...
def seed_data(request):
    try:
        ...
        shift_objs = []
        for t in templates:
            obj, _ = ShiftTemplate.objects.get_or_create(name=t['name'], defaults=t)
        ...
        return Response({'status': 'Dummy data seeded successfully (45 users created)!', 'roster_created': created})
